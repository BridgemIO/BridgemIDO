...
contract BDGMPublicSale is Ownable, ReentrancyGuard {
    ...
    constructor(){
        joinIdoPrice=571000000000;
        stakeAmount=11420000000000000000;
    ...
    function joinIdo() external payable nonReentrant {
        ...
        require(10**8 <= msg.value, "BDGMPublicSale:value sent is too small");
    ...
    function claimToken() external nonReentrant{
        require(mbStart, "BDGMPublicSale: not Start!");
